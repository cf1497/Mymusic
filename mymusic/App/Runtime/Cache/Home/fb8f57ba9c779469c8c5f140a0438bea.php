...
<div class="ucenter">
	<div class="container">
		<form action="<?php echo U('User/editProfile');?>"  method="post" class="form-inline">
		<table class="table table-condensed table-bordered">
			...
			<tr>
				...
				<td><span><input type="text" name="city" value="<?php echo ($user["user_city"]); ?>"></span></td>
			</tr>
			<tr>
				<td width="200"><span>birthday</span></td>
				<td><span><input type="text" name="birthday" value="<?php echo ($user["user_birthday"]); ?>">&nbsp;(format:yyyy-mm-dd)</span></td>
			</tr>
		</table>
		<input type="submit" class="btn" value="edit">&nbsp;or&nbsp;<a href="javascript:history.go(-1)" class="btn">go back</a>
	</form>
