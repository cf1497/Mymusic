	...
	<div class="container">
		...
		<?php if(is_array($content)): foreach($content as $key=>$v): ?><div style="width:100%;border:1px solid silver;float:left;margin-bottom:20px;">
			...
			<div style="width:100%;border:0px solid red;float:left;">
				...
				<form action="<?php echo U('User/comment');?>" method="post">
					<input type="hidden" name="id" value="<?php echo ($v['id']); ?>">
					<textarea class="fl" name="comment"></textarea><input  type="submit" value="comment">
				</form>
			</div>
			<div style="width:100%;border:1px solid pink;float:left;">COMMENTS:<br>
